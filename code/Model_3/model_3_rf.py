...
X = df_encoded[['impervious', 'Pv', 'NDWI', 'elev', 'climate_category_Arid (Cold)', 'climate_category_Arid (Hot)',
                ...
                'Total_Population', 'Median_Age', 'Per_Capita_Income', 'Families_Below_Poverty',
                'year_centered'
                ]]

# X = df_encoded[['impervious', 'Pv', 'NDWI', 'elev', 'climate_category_Arid (Cold)', 'climate_category_Arid (Hot)', 'climate_category_Mediterranean', 'climate_category_Semi-Arid (Cold)', 'urban_rural_classification_U', 'urban_rural_classification_nan', 'year_centered']]
...
# Export as trained model
with open('model3_rf_trained_model_1.pkl', 'wb') as file:
    pickle.dump(model, file)
# joblib.dump(model, 'model3_rf_trained_model.pkl')
