...
# 1. Load the data
df = pd.read_csv(r'C:\Users\aarav\ScienceProject24-25\heatislandeffect\Model_2\merged_environmental_census_data.csv')
...
# plt.figure(figsize=(10, 6))
# sns.barplot(x=best_features, y=coefficients)
# plt.xlabel('Features')
